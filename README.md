...
_Takes a dollar amount as input and returns the most efficient combination of change (fewest number of coins)._

## Setup/Installation Requirements

* Clone this repository from [gitHub](https://github.com/MBAllely/change_counter)
...
Copyright (c) 2016 _**Marika 'Space Pants' Allely and Adam 'Ross Hustled' Russell**_
